...
<body>
 ...
 <td><a href="/tp/Public/<?php echo ($v["picture"]); ?>"><image src="/tp/Public/<?php echo ($v["picture"]); ?>" width="20px" height="30px"></image></td>
  <td><?php echo ($v["id"]); ?></td>
  <td>
  <?php echo ($v["title"]); ?>
  ...
  <td>
  <a href="<?php echo U('Admin/Blog/moveblog',array('blog_id'=>$v[id]));?>">移动到回收站</a>
  <a href="<?php echo U('Admin/Blog/changeblog',array('cblog_id'=>$v[id]));?>">修改博文</a>
  </td>
