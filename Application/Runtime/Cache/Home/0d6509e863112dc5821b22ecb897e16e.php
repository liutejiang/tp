...
<html lang="en">
 		...
 		<div class="navbar">
 			...
 			<div class="navigation">
 				<ul class="nav_list">
 					...
 					<?php if(is_array($cate_data)): foreach($cate_data as $key=>$v): ?><li class="nav_list_item"><a href="<?php echo U('Home/Index/showCateblog',array('cate_id'=>$v[id]));?>"><?php echo ($v["name"]); ?></a> </li><?php endforeach; endif; ?>
 				</ul>
 			</div>
 		</div>
 	</div>
 <div class="body_container">
 	...
 	<?php if(is_array($blog_article)): foreach($blog_article as $key=>$v): ?><div class="center_new" id="center_new1">
